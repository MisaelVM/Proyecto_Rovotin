...
private:
    ...
    std::vector<glm::vec3> armDirections{};
    std::vector<glm::vec3> handPositions{};
    std::vector<glm::vec3> elbowPositions{};
    ...
    void Serialize(Joint* pJoints, JointOrientation* pJointOrientations, const HandState& handState);
    void EndEmission();
};
